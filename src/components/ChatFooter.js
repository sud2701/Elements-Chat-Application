...
import { sendMessage } from '../requests/api'
...
const ChatFooter = () => {
    ...
    return (
        <div className="sticky flex flex-row items-center w-full bottom-0 h-24 bg-black">
            ...
            <div className="flex flex-col w-full">
                {
                    replyContext && <div>
                        <p className="text-white">{replyContext.reply_to.message.message}</p>
                    </div>
                }
                <input
                    type="text"
